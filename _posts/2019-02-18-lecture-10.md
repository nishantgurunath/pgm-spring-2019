...
since the posterior covariance ($V_{1|2}$ above) and does not depend on the observed
...
where m, V refer to the mean and covariance of the joint distribution respectively. 
